...
**FallImmig · sovereign single-file UK immigration law OS** — sovereign SDK extracted from `fallimmig/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallimmig-sdk
```

## Use
```js
import * as fallimmig from '@ai-native-solutions/fallimmig-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallimmig-sdk/
- MCP wrapper: [`@ai-native-solutions/fallimmig-mcp`](https://github.com/sjgant80-hub/fallimmig-mcp)
- HTTP API: [`@ai-native-solutions/fallimmig-api`](https://github.com/sjgant80-hub/fallimmig-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallimmig-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallimmig-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallimmig-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallimmig-sdk -- npx -y @ai-native-solutions/fallimmig-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallimmig-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallimmig-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallimmig-sdk/
- **Source**: https://github.com/sjgant80-hub/fallimmig-sdk
